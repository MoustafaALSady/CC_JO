...
Public Class FormScan1
    ReadOnly OFD As New OpenFileDialog ' تعريف متغير من نوع فتح ملف
    ReadOnly F As New FrmJPG
    ...
    Private Sub ButSave_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles ButSave.Click
        ...
        Try
            ...
            Dim SQL As New SqlClient.SqlCommand(" Update MYDOCUMENTSHOME SET  DOC6 = @DOC6 WHERE DOC1 = '" & Me.TextBox1.Text & "'", Consum)
