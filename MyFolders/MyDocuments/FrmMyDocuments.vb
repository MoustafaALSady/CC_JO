...
Public Class FrmMyDocuments
    ...
    Private Sub CMDBROWSE_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDBROWSE.Click
        Try
            ...
            With Me.OpenFileDialog1
                .FilterIndex = 2
                .Title = "ÍÏÏ ÇáãáÝ ÇáÐì ÊÑíÏ ÝÊÍÉ"
                .ShowDialog()
    ...
    Private Sub CMDBROWSE2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDBROWSE2.Click
        Try
            ...
            Else
                MessageBox.Show(" åÐÇ ÇáãáÝ ÛíÑ ãæÌæÏ Þì ÇáãÓÇÑ ÇáãÍÏÏ", Me.ComboBox1.Text + ".pdf", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1, MessageBoxOptions.RtlReading)
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
