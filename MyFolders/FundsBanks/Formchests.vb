...
<<<<<<< HEAD
    Private Sub Formchests_KeyUp(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyUp
=======
    Private Sub Formchests_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        Try
...
<<<<<<< HEAD
        ...
        Dim SQL As New SqlCommand("SELECT MAX(CB1) FROM CashBox  WHERE CUser='" & CUser & "'", Consum)
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        ...
        If IsDBNull(resualt) Then
            Me.TextCB1.Text = CUser & 1
        Else
            Me.TextCB1.Text = CType(resualt, Integer) + 1
        End If
        Consum.Close()
    End Sub
<<<<<<< HEAD
    Private Sub Formchests_Load(ByVal sender As System.Object, ByVal e As EventArgs) Handles MyBase.Load
=======
    Private Sub Formchests_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        Try
...
1:
    ...
    Private Sub SaveData_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles SaveTab.RunWorkerCompleted
        Try
            ...
            'End If
            Application.DoEvents()
            Me.BS.DataSource = Me.myds.Tables("CashBox")
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
    ...
    Public Sub RecordCount()
        ...
        If BS.Position > 0 Then
            Back = True
        End If
        If Me.BS.Position < Me.myds.Tables("CashBox").Rows.Count - 1 Then
            Forward = True
        End If
        Me.SHOWBUTTON()
...
<<<<<<< HEAD
            Dim Consum As New SqlConnection(constring)
            Dim SQL As String = "INSERT INTO CashBox( CB1, CB2, CUser, COUser) VALUES     ( @CB1, @CB2, @CUser, @COUser)"
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
            With cmd
                .CommandType = CommandType.Text
                .Connection = Consum
                .Parameters.Add("@CB1", SqlDbType.Int).Value = Me.TextCB1.Text.Trim
            ...
            cmd.ExecuteNonQuery()
            Consum.Close()
            Insert_Actions(Me.TextIDCB.Text.Trim, "حفظ", Me.Text)
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
...
<<<<<<< HEAD
            ...
            Dim strSQL As New SqlCommand("", Consum) With {
                .CommandText = String.Concat(New String() {"SELECT  IDCB, CB1, CB2,  CUser, COUser FROM CashBox  WHERE  CUser='", ModuleGeneral.CUser, "'ORDER BY IDCB"})
            }
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
            ...
            Me.myds = New DataSet
            Consum.Open()
            Me.SqlDataAdapter1.Fill(Me.myds, "CashBox")
    ...
    Private Sub BackWorker2_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackWorker2.RunWorkerCompleted
        Try
            ...
            Me.BS.DataSource = Me.myds.Tables("CashBox")
            RowCount = BS.Count
            TextIDCB.DataBindings.Add("text", BS, "IDCB", True, 1, "")
            TextCB1.DataBindings.Add("text", BS, "CB1", True, 1, "")
            TextCB2.DataBindings.Add("text", BS, "CB2", True, 1, "")
            Call MangUsers()
            Me.RecordCount()
            Me.ADDBUTTON.Enabled = True
            Me.SAVEBUTTON.Enabled = False
...
<<<<<<< HEAD
            Dim Consum As New SqlConnection(constring)
            Dim SQL As New SqlCommand(" Update CashBox SET   CB1 = @CB1, CB2 = @CB2  WHERE IDCB = @IDCB", Consum)
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
            ...
            With CMD
                .CommandType = CommandType.Text
                .Connection = Consum
                .Parameters.Add("@IDCB", SqlDbType.Int).Value = Me.TextIDCB.Text
                .Parameters.Add("@CB1", SqlDbType.NVarChar).Value = Me.TextCB1.Text.Trim
                .Parameters.Add("@CB2", SqlDbType.NVarChar).Value = Me.TextCB2.Text.Trim
                .CommandText = SQL.CommandText
            End With
            If Consum.State = ConnectionState.Open Then Consum.Close()
            ...
            CMD.ExecuteNonQuery()
            Consum.Close()
            Insert_Actions(Me.TextIDCB.Text.Trim, "تعديل", Me.Text)
        Catch ex As Exception
    ...
    Private Sub ButCB2_Click(sender As Object, e As EventArgs) Handles ButCB2.Click
        Try
            ...
            If F.ACCEPT = True Then
                ...
                Me.TextCB2.Text = F.DGV.Rows(I).Cells("account_name").Value.ToString
            End If
        Catch ex As Exception
