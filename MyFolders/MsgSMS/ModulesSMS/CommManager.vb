...
#Region "Manager Variables"
    ...
    Private ReadOnly comPort As New SerialPort()
...
#Region "DisplayData"
    ...
    Private Sub DisplayData(Type As MessageType, msg As String)
        ...
        DisplayWindow.Invoke(New EventHandler(AddressOf DoDisplay))
    End Sub
#End Region
...
#Region "SetParityValues"
    Public Shared Sub SetParityValues(ByVal obj As Object)
...
#Region "SetStopBitValues"
    Public Shared Sub SetStopBitValues(ByVal obj As Object)
...
#Region "SetPortNameValues"
    Public Shared Sub SetPortNameValues(ByVal obj As Object)
