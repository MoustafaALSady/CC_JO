...
Public Class ConnSMS
    ...
    Public Shared ReadOnly Property MyPhoneExplorerApplicationName() As String
        Get
            Return "MyPhoneExplorer"
        End Get
    End Property
    'Public Function SendSMS(ByVal phoneNumber As String, ByVal messageText As String) As Boolean
    ...
    Public Shared ReadOnly Property MyPhoneExplorerFullPath() As String
        Get
    ...
    Shared Sub CallPhoneNumber(ByVal phoneNumber As String)
        Dim fileName As String = MyPhoneExplorerFullPath
    ...
    Private Shared Sub StartPhoneExplorerWithArguments(ByVal fileName As String, ByVal arguments As String)
