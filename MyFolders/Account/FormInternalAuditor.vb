...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
            ...
            If dt.Rows.Count > 0 Then
                ...
                Me.DataGridView2.Columns(1).HeaderText = "اسم الجمعية"
                Me.DataGridView2.Columns(2).HeaderText = "الرقم الوطني للجمعية"
                Me.DataGridView2.Columns(3).HeaderText = "السنة المالية"
                Me.DataGridView2.Columns(4).HeaderText = "اسم المدقق"
                Me.DataGridView2.Columns(5).HeaderText = "اعتماد المحاسب"
                Me.DataGridView2.Columns(6).HeaderText = "اعتماد مدقق الحسابات"
                Me.DataGridView2.Columns(7).HeaderText = "اعتماد مدير التعاون"
                Me.DataGridView2.Columns(8).HeaderText = "اعتماد رئيس قسم الحسابات الخارجي"
                Me.DataGridView2.Columns(9).HeaderText = "اعتماد مدقق الحسابات الخارجي"
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "ErrorDoWork(", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End Try
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        Try
            If dt.Rows.Count > 0 Then
                'Me.TextBox1.Text = Me.DataGridView2.Rows.Count
                Me.IDFL1.Text = Me.DataGridView2.CurrentRow.Cells(0).Value
                Me.TextAssociationName.Text = Me.DataGridView2.CurrentRow.Cells(1).Value
                Me.TextAssociationNationalNumber.Text = Me.DataGridView2.CurrentRow.Cells(2).Value
                Me.TextFiscalYear.Text = Me.DataGridView2.CurrentRow.Cells(3).Value
                Me.TextCondition.Text = Me.DataGridView2.CurrentRow.Cells(11).Value
                Me.TextReasonsForRejectingBudgetFromAuditor.Text = Me.DataGridView2.CurrentRow.Cells(12).Value
                Me.TextReasonsForRejectingBudgetFromDirectorOfCooperation.Text = Me.DataGridView2.CurrentRow.Cells(13).Value
                Me.TextReasonsForRejectingBudgetFromHeadOfExternalAccountsDepartment.Text = Me.DataGridView2.CurrentRow.Cells(14).Value
                Me.TextReasonsForRejectingBudgetFromExternalAuditor.Text = Me.DataGridView2.CurrentRow.Cells(15).Value
                Me.DataGridView2.Columns(0).Visible = False
                ...
                If dt.Rows(0).Item("FL6") = True And dt.Rows(0).Item("FL10") = "2" Then
                    Me.ButtonApproval.Enabled = False
                    Me.ButtonRefusal.Enabled = True
                ElseIf dt.Rows(0).Item("FL6") = False And dt.Rows(0).Item("FL10") = "0" Then
                    Me.ButtonApproval.Enabled = True
                    Me.ButtonRefusal.Enabled = False
                ElseIf dt.Rows(0).Item("FL6") = False And dt.Rows(0).Item("FL10") = "1" Then
                    Me.ButtonApproval.Enabled = True
                    Me.ButtonRefusal.Enabled = True
                End If
                If dt.Rows(0).Item("FL7") = True Then
                    Me.ButtonApproval.Enabled = False
                    Me.ButtonRefusal.Enabled = False
                End If
            End If
            FILLCOMBOBOX3("FinancialList", "FL1", "FL3", FiscalYear_currentDateMustBeInFiscalYear(), "FL5", Trim("True"), Me.ComboAssociationName)
            Auditor("FinancialList", "USERNAME", "IDFL", Me.IDFL1.Text, "")
            Logentry = Uses
            Consum.Close()
            'If CollaborationManager1 = True Or HeadofAuditingDepartment1 = True Or ExternalAuditor1 = True Then
            '    Me.ButtonAttachDocument.Enabled = False
            '    Me.ButtonApproval.Enabled = False
            '    Me.ButtonRefusal.Enabled = False
            'Else
            ...
            Me.DataGridView2.RowsDefaultCellStyle.Alignment = DataGridViewContentAlignment.BottomCenter
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
            ...
            If dt.Rows.Count > 0 Then
                ...
                Me.DataGridView2.Columns(8).HeaderText = "اعتماد رئيس قسم الحسابات الخارجي"
                Me.DataGridView2.Columns(9).HeaderText = "اعتماد مدقق الحسابات الخارجي"
                Me.TextNumberOfAssociationsSent.Text = Me.DataGridView2.Rows.Count
                Me.IDFL1.Text = Me.DataGridView2.CurrentRow.Cells(0).Value
                Me.TextAssociationName.Text = Me.DataGridView2.CurrentRow.Cells(1).Value
                Me.TextAssociationNationalNumber.Text = Me.DataGridView2.CurrentRow.Cells(2).Value
                Me.TextFiscalYear.Text = Me.DataGridView2.CurrentRow.Cells(3).Value
            ...
            SqlDataAdapter1.Dispose()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "ErrorLoadFormInternalAuditor", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End Try
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
                        ...
                        'Dim str3 As New SqlClient.SqlCommand("SELECT MOVD4, account_no, MOVD3, account_name, SUMDEBIT1, SUMCREDIT1, SUMDEBIT, SUMCREDIT, AccountKind, ACC, yearearlier, YEAR, YEAR1, CUser, CUser1  FROM Previouspost1 WHERE (yearearlier ='" & FiscalYear_currentDateMustBeInFiscalYear() - 1 & "') And (YEAR  ='" & FiscalYear_currentDateMustBeInFiscalYear() & "') And (CUser ='" & CUser & "') Or  (yearearlier Is NULL) And (YEAR='" & FiscalYear_currentDateMustBeInFiscalYear() & "') And ( CUser ='" & CUser & "') ", Consum)
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        ...
        SELECT_MOVES4(Me.DataGridView1)
        CountDATAITEMS1()
        Call AuditorClose()
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        Try
            ...
            IDFL = SEARCHDATA.NumberDOCUMENTSFL
            ...
            f.TextFileDescription.Text = "ارفاق مستندات مدقق الحسابات"
            f.PictureBox1.Image = Nothing
            f.TextFileNo.Enabled = False
            f.TextTransactionNumber.Enabled = False
            Insert_Actions(IDFL1.Text, " ارفاق مستندات مدقق الحسابات", Me.Text)
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
    End Sub
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
                ...
                With CMD
                    ...
                    .Parameters.Add("@FL6", SqlDbType.Bit).Value = True
                    .Parameters.Add("@FL10", SqlDbType.NVarChar).Value = "2"
                    .Parameters.Add("@FL11", SqlDbType.NVarChar).Value = "تم الانتهاء من العمل وجاري ارسالها الي مدير التعاون"
                ...
                CMD.ExecuteNonQuery()
                Consum.Close()
                FormInternalAuditor_Load(sender, e)
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
                ...
                With CMD
                    ...
                    .Parameters.Add("@FL10", SqlDbType.NVarChar).Value = "1"
                    .Parameters.Add("@FL11", SqlDbType.NVarChar).Value = "تم رفض الموازنه وجاري ارجاعة الي المحاسب"
                    .Parameters.Add("@FL12", SqlDbType.NVarChar).Value = Me.TextReasonsForRejectingBudgetFromAuditor.Text
                    .Parameters.Add("@CUser", SqlDbType.NVarChar).Value = CUser
                    .Parameters.Add("@COUser", SqlDbType.NVarChar).Value = COUser
                    .Parameters.Add("@da", SqlDbType.NVarChar).Value = ServerDateTime.ToString("yyyy-MM-dd")
                    .Parameters.Add("@ne", SqlDbType.NVarChar).Value = ServerDateTime.ToString("hh:mm:ss tt")
