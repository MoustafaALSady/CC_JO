...
Public Class FormHeadofAuditingDepartment
<<<<<<< HEAD
    Inherits Form
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
            dt = New DataTable
            Me.SqlDataAdapter1 = New SqlDataAdapter("select  IDFL, FL1, FL2, FL3, FL4, FL5, FL6, FL7, FL8, FL9, FL10, FL11, FL12, FL13, FL14, FL15  from FinancialList     WHERE  FL3 ='" & FiscalYear_currentDateMustBeInFiscalYear() & "' and  FL7='" & True & "'  ", Consum)
            ...
            Else
                ...
                Me.ButtonAddStatisticalStatement.Enabled = False
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        If dt.Rows.Count > 0 Then
            ...
            If dt.Rows(0).Item("FL8") = True And dt.Rows(0).Item("FL10") = "4" Then
                Me.ButtonApproval.Enabled = False
                Me.ButtonRefusal.Enabled = True
            ElseIf dt.Rows(0).Item("FL8") = False And dt.Rows(0).Item("FL10") = "2" Then
                Me.ButtonApproval.Enabled = True
                Me.ButtonRefusal.Enabled = False
            ElseIf dt.Rows(0).Item("FL8") = False And dt.Rows(0).Item("FL10") = "3" Then
                Me.ButtonApproval.Enabled = True
                Me.ButtonRefusal.Enabled = True
            End If
            If dt.Rows(0).Item("FL9") = True Then
                Me.ButtonApproval.Enabled = False
                Me.ButtonRefusal.Enabled = False
            End If
        End If

        FILLCOMBOBOX3("FinancialList", "FL1", "FL3", FiscalYear_currentDateMustBeInFiscalYear(), "FL7", Trim("True"), Me.ComboAssociationName)
    ...
    End Sub
<<<<<<< HEAD
    Private Sub FormHeadofAuditingDepartment_Load(ByVal sender As System.Object, ByVal e As EventArgs) Handles MyBase.Load
=======
    Private Sub FormHeadofAuditingDepartment_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
...
<<<<<<< HEAD
        Dim SqlDataAdapter12 As New SqlDataAdapter
        Dim str12 As New SqlCommand("SELECT * FROM StatisticalStatement   WHERE  CUser='" & ModuleGeneral.CUser & "' and SS7 ='" & FiscalYear_currentDateMustBeInFiscalYear() & "'  ", Consum)
        SqlDataAdapter12 = New SqlDataAdapter(str12)
=======
        Dim SqlDataAdapter12 As New SqlClient.SqlDataAdapter
        Dim str12 As New SqlCommand("SELECT * FROM StatisticalStatement   WHERE  CUser='" & ModuleGeneral.CUser & "' and SS7 ='" & FiscalYear_currentDateMustBeInFiscalYear() & "'  ", Consum)
        SqlDataAdapter12 = New SqlClient.SqlDataAdapter(str12)
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        ds12.Clear()
        SqlDataAdapter12.Fill(ds12, "StatisticalStatement")
        If ds12.Tables(0).Rows.Count > 0 Then
            AB12 = "12"
            DataGrid.Rows.Add("=== البيان الاحصائي ===", "12", Nothing, Nothing, Nothing, Nothing, Nothing)
            RB12 = True
        Else
            AB12 = "0"
            RB12 = False
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
    ...
    Private Sub BackgroundWorker2_RunWorkerCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker2.RunWorkerCompleted
        ...
        '    Me.ButtonAddStatisticalStatement.Enabled = True
        '    Me.ButtonApproval.Enabled = True
        '    Me.ButtonRefusal.Enabled = True
        'End If
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        Try
            ...
            f.TextFileDescription.Text = "ارفاق مستندات رئيس قسم الحسابات الخارجية"
            f.PictureBox1.Image = Nothing
            f.TextFileNo.Enabled = False
            f.TextTransactionNumber.Enabled = False
            Insert_Actions(IDFL1.Text, " ارفاق مستندات رئيس قسم الحسابات الخارجية", Me.Text)
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
    End Sub
...
<<<<<<< HEAD
                Dim Consum As New SqlConnection(constring)
                'MAXIDBudget()
                Dim SQL As New SqlCommand(" Update FinancialList SET    FL8 = @FL8, FL10 = @FL10, FL11 = @FL11, FL14 = @FL14, USERNAME = @USERNAME, Auditor = @Auditor, CUser = @CUser, COUser = @COUser, da = @da, ne = @ne WHERE IDFL = @IDFL", Consum)
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
                ...
                With CMD
                    ...
                    .Parameters.Add("@FL8", SqlDbType.Bit).Value = True
                    .Parameters.Add("@FL10", SqlDbType.NVarChar).Value = "4"
                    .Parameters.Add("@FL11", SqlDbType.NVarChar).Value = "تم الانتهاء من العمل وجاري ارسالها الي مدقق الحسابات الخارجي"
                ...
                CMD.ExecuteNonQuery()
                Consum.Close()
                FormHeadofAuditingDepartment_Load(sender, e)
...
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
                ...
                With CMD
                    ...
                    .Parameters.Add("@FL11", SqlDbType.NVarChar).Value = "تم رفض الموازنه وجاري ارجاعة الي مدير التعاون"
                    .Parameters.Add("@FL14", SqlDbType.NVarChar).Value = Me.TextReasonsForRejectingBudgetFromHeadOfExternalAccountsDepartment.Text
                    .Parameters.Add("@CUser", SqlDbType.NVarChar).Value = CUser
                    .Parameters.Add("@COUser", SqlDbType.NVarChar).Value = COUser
                    .Parameters.Add("@da", SqlDbType.NVarChar).Value = ServerDateTime.ToString("yyyy-MM-dd")
                    .Parameters.Add("@ne", SqlDbType.NVarChar).Value = ServerDateTime.ToString("hh:mm:ss tt")
...
<<<<<<< HEAD
    Private Sub ButtonAddStatisticalStatement_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles ButtonAddStatisticalStatement.Click
=======
    Private Sub ButtonAddStatisticalStatement_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonAddStatisticalStatement.Click
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        On Error Resume Next
        Dim F As New FormStatisticalStatement
