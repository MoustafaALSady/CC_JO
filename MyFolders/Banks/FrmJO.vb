...
Public Class FrmJO
    ...
    Private Sub FrmJO_Activated(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Activated
        On Error Resume Next
    End Sub
    Private Sub FrmJO_KeyUp(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyUp
        Try
        ...
        End Try
    End Sub
    Private Sub FrmJO_Shown(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Shown
        On Error Resume Next
        Me.Show()
        Me.TabPage1.Show()
        Me.TabPage3.Show()
        ...
        Me.TabPage1.Show()
    End Sub
    Private Sub FrmJO_Load(ByVal sender As System.Object, ByVal e As EventArgs) Handles MyBase.Load
        On Error Resume Next
...
1:
    ...
    Private Sub BALANCEBUTTON_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles BALANCEBUTTON.Click
        ...
        Me.BackWorker3 = New BackgroundWorker With {
            .WorkerReportsProgress = True,
            .WorkerSupportsCancellation = True
        }
    ...
    Private Sub TEXTBOX5_KeyPress(ByVal sender As Object, ByVal e As KeyPressEventArgs)
        ...
        End If
    End Sub
    Private Sub ComboBN2_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ComboBN2.SelectedIndexChanged
        Dim Consum As New SqlConnection(constring)
        Dim Adp As SqlDataAdapter
        On Error Resume Next
    ...
    End Sub
    Private Sub TEXTBOX2_TextChanged1(ByVal sender As Object, ByVal e As EventArgs) Handles TEXTPreviousBalance.TextChanged, TEXTCurrentBalance.TextChanged, ComboBN2.TextChanged, TEXTDebit.EditValueChanged, TEXTCredit.EditValueChanged
        On Error Resume Next
        Me.InternalAuditorBalance()
    ...
    Private Sub UPDATERECORDCASHIER()
        ...
        Consum.Close()
        Dim SQL As New SqlCommand(" Update CASHIER SET  CSH2 = @CSH2, CSH3 = @CSH3, CSH4 = @CSH4, CSH5 = @CSH5, CSH7 = @CSH7, CSH8 = @CSH8, CSH10 = @CSH10, CSH11 = @CSH11, CSH12 = @CSH12, CSH15 = @CSH15, CSH17 = @CSH17, USERNAME = @USERNAME, CUser = @CUser, COUser = @COUser, da = @da, ne = @ne WHERE CSH4 = '" & Me.TextMovementSymbol.EditValue.ToString & "'" & "AND CSH15 = '" & Me.TEXTDocumentNumber.Text.ToString & "'", Consum)
        Dim CMD As New SqlCommand With {
            .CommandType = CommandType.Text,
            .Connection = Consum
        }
    ...
    Private Sub DELETEDATACASHIER()
        ...
        End Try
    End Sub
    Private Sub ButtonTransferToCashMovements_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles ButtonTransferToCashMovements.Click
        Try
            If TestNet = False Then
                MsgBox("«·« ’«· »«·«‰ —‰  €Ì— „ Ê›—", 16, " ‰»ÌÂ")
                Exit Sub
    ...
    Private Sub TextBox19_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles TextGoTo.TextChanged
        ...
        End Try
    End Sub
    Private Sub TEXTBOX8_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ComboConstraintType.SelectedIndexChanged
        'Try
    ...
    Private Sub ButtonUpdateA_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles ButtonUpdateA.Click
        ...
        End Try
    End Sub
    Private Sub PictureBox6_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles PicFundMovementNumber.Click
        Dim ds As New DataSet
        Dim SqlDataAdapter1 As New SqlDataAdapter
        Dim SqlConnection2 As New SqlConnection
        Dim Consum As New SqlConnection(constring)
    ...
    End Sub
    Private Sub FrmJO_FormClosing(ByVal sender As Object, ByVal e As FormClosingEventArgs) Handles Me.FormClosing
        If Me.BackWorker3.IsBusy Then
            Me.BackWorker3.CancelAsync()
        End If
    End Sub
