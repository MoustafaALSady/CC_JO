...
Public Class FrmDeposits1
    ...
    Private Sub FrmDeposits1_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
        Try
        ...
        End Try
    End Sub
    Private Sub FrmDeposits1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
...
1:
    ...
    Private Sub SAVERECORD()
        Try
            ...
            With cmd
                ...
                .Connection = Consum
                .Parameters.Add("@TBNK1", SqlDbType.Int).Value = TEXTID.EditValue
    ...
    Private Sub ButtonXP2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonXP2.Click
        ...
        End Try
    End Sub
    Private Sub ComboBox2_KeyPress1(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
