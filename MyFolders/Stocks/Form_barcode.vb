...
Public Class Form_barcode
    ...
    Friend WithEvents GroupControl4 As GroupControl
    ...
    Friend WithEvents TxtItemsPrixVente As TextEdit
    Friend WithEvents TxtItemsName As TextEdit
    Friend WithEvents TxtItemsBarcode As TextEdit
    Friend WithEvents SearchLookUpEdit1 As SearchLookUpEdit
    ...
    Private Sub InitializeComponent()
        ...
        Me.TxtSettingsEntreprise = New TextEdit()
        ...
        Me.TxtItemsPrixVente = New TextEdit()
        Me.TxtItemsName = New TextEdit()
        Me.TxtItemsBarcode = New TextEdit()
        Me.SearchLookUpEdit1 = New SearchLookUpEdit()
        Me.SearchLookUpEdit1View = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.GroupControl2 = New GroupControl()
        Me.TxtNumberStickers = New TextEdit()
        Me.Button1 = New SimpleButton()
        ...
        Me.RepositoryItemProgressBar1 = New Repository.RepositoryItemProgressBar()
        ...
        Me.RepositoryItemZoomTrackBar1 = New Repository.RepositoryItemZoomTrackBar()
        ...
        CType(Me.TxtItemsPrixVente.Properties, ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.TxtItemsName.Properties, ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.TxtItemsBarcode.Properties, ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.SearchLookUpEdit1.Properties, ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.SearchLookUpEdit1View, ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.GroupControl2, ComponentModel.ISupportInitialize).BeginInit()
        Me.GroupControl2.SuspendLayout()
        CType(Me.TxtNumberStickers.Properties, ComponentModel.ISupportInitialize).BeginInit()
        CType(Me.GroupControl1, ComponentModel.ISupportInitialize).BeginInit()
        Me.GroupControl1.SuspendLayout()
        CType(Me.PictureBox1, ComponentModel.ISupportInitialize).BeginInit()
        Me.Panel1.SuspendLayout()
        Me.Panel3.SuspendLayout()
        CType(Me.DocumentViewerBarManager1, ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.PrintPreviewRepositoryItemComboBox1.Buttons.AddRange(New Controls.EditorButton() {New Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)})
        ...
        Me.BarDockControlTop.Size = New Size(1105, 47)
        '
        'BarDockControlBottom
        '
        Me.BarDockControlBottom.CausesValidation = False
        Me.BarDockControlBottom.Dock = System.Windows.Forms.DockStyle.Bottom
        Me.BarDockControlBottom.Location = New Point(0, 535)
        Me.BarDockControlBottom.Manager = Me.DocumentViewerBarManager1
        Me.BarDockControlBottom.Size = New Size(1105, 24)
        '
        'BarDockControlLeft
        '
        Me.BarDockControlLeft.CausesValidation = False
        Me.BarDockControlLeft.Dock = System.Windows.Forms.DockStyle.Left
        Me.BarDockControlLeft.Location = New Point(0, 47)
        Me.BarDockControlLeft.Manager = Me.DocumentViewerBarManager1
        Me.BarDockControlLeft.Size = New Size(0, 488)
        '
        'BarDockControlRight
        '
        ...
        CType(Me.TxtItemsPrixVente.Properties, ComponentModel.ISupportInitialize).EndInit()
        CType(Me.TxtItemsName.Properties, ComponentModel.ISupportInitialize).EndInit()
        CType(Me.TxtItemsBarcode.Properties, ComponentModel.ISupportInitialize).EndInit()
        CType(Me.SearchLookUpEdit1.Properties, ComponentModel.ISupportInitialize).EndInit()
        CType(Me.SearchLookUpEdit1View, ComponentModel.ISupportInitialize).EndInit()
        CType(Me.GroupControl2, ComponentModel.ISupportInitialize).EndInit()
        Me.GroupControl2.ResumeLayout(False)
        CType(Me.TxtNumberStickers.Properties, ComponentModel.ISupportInitialize).EndInit()
        CType(Me.GroupControl1, ComponentModel.ISupportInitialize).EndInit()
        Me.GroupControl1.ResumeLayout(False)
        CType(Me.PictureBox1, ComponentModel.ISupportInitialize).EndInit()
        Me.Panel1.ResumeLayout(False)
        Me.Panel3.ResumeLayout(False)
        CType(Me.DocumentViewerBarManager1, ComponentModel.ISupportInitialize).EndInit()
