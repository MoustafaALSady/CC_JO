...
=======
    Private Sub FrmStocks1_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Shown
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
...
=======
    Private Sub FrmStocks1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        On Error Resume Next
...
=======
    Private Sub TEXT2_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TEXTUserName.KeyDown, TEXTReviewDate.KeyDown, TEXTReferenceName.KeyDown, TEXTITEMNAME.KeyDown, TEXTITEMCODE.KeyDown, TEXTGROUPCODE.KeyDown, ComboHashUnit.KeyDown, ComboGROUPNAME.KeyDown
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        On Error Resume Next
...
=======
    Private Sub SEARCHDATAITEMS8()
        ...
        Dim cmd1 As New SqlClient.SqlCommand("SELECT MAX(STK1) FROM STOCKS WHERE  STOCKS.STK25 ='" & TEXTITEMCODE.Text.Trim & "'", Consum)
        If Consum.State = ConnectionState.Open Then Consum.Close()
        Consum.Open()
        N = cmd1.ExecuteScalar
        Me.TextSumAmounTOTALSTOCKS.Text = Format(Val(SumAmounTOTALSTOCKS(TEXTITEMCODE.Text.Trim, N)), "0.000")
    End Sub
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
...
=======
        Dim Consum As New SqlClient.SqlConnection(constring)
        Dim strsql1 As New SqlClient.SqlCommand("SELECT DISTINCT STK1 FROM STOCKS WHERE STK25 = '" & Me.TEXTITEMCODE.Text & "'", Consum)
        Dim ds1 As New DataSet
...
=======
        ...
        If Consum.State = ConnectionState.Open Then Consum.Close()
        Consum.Open()
        Dim sql As New SqlClient.SqlCommand("UPDATE STOCKS SET STK25 = @STK25 WHERE STK7='" & Me.TEXTITEMNAME.Text.Trim & "'" & " AND CUser='" & CUser & "'", Consum)
        Dim CMD As New SqlClient.SqlCommand With {
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
            .CommandType = CommandType.Text,
            .Connection = Consum
...
=======
    Private Sub LISTBOX_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LISTBOX.Click
        ...
        Me.BS.Position = Me.LISTBOX.SelectedIndex
    End Sub
    Private Sub TEXT7_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles TEXTUnitPrice.EditValueChanged, TextThirdSalePrice.EditValueChanged, TextSecondSellingPrice.EditValueChanged, TextHashUnitNumber2.EditValueChanged, TextHashUnitNumber1.EditValueChanged, TEXTDiscount.EditValueChanged
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        On Error Resume Next
...
=======
    Private Sub ButAA_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonItemCode.Click
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
...
=======
    Private Sub Buted_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Buted.Click
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        On Error Resume Next
