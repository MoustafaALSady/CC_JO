...
#Region "Properties"
    ...
    Protected Friend ReadOnly Property IsNewAppointment() As Boolean
        Get
            Return m_controller Is Nothing OrElse m_controller.IsNewAppointment
        End Get
    End Property
...
#End Region
    ...
    Private Sub ExportAppointment(ByVal stream As Stream)
        ...
        Dim aptsToExport As New AppointmentBaseCollection From {
            Controller.EditedAppointmentCopy
        }
        Dim exporter As New iCalendarExporter(Me.m_storage, aptsToExport) With {
    ...
    Protected Overridable Sub OnPrintButton()
        Using tool As New PrintTool(Me.appointmentBackstageControl.Document)
    ...
    Private Sub BvbSaveAs_ItemClick(ByVal sender As Object, ByVal e As Ribbon.BackstageViewItemEventArgs) Handles bvbSaveAs.ItemClick
        OnSaveAsButton()
    End Sub
