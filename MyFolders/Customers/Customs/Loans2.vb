...
=======
    Private Sub Loans2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
...
=======
        ...
        Dim AsUser1 As New SqlCommand("select loa from LoansPa where lo = '" & Me.TextDebtNumber.Text & "'", Consum)
        Dim ds5 As New DataSet
        Adp = New SqlClient.SqlDataAdapter(AsUser1)
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
        ds5.Clear()
        Consum.Open()
...
<<<<<<< HEAD
    ...
    Private Sub ComboBox2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As EventArgs) Handles ComboCustomerName.SelectedIndexChanged
        ...
        Dim Consum As New SqlConnection(constring)
=======
    Private Sub TEXTBOX14_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextDebtNumber.SelectedIndexChanged
        On Error Resume Next
        NOLOA()
    End Sub
...
<<<<<<< HEAD
    Private Sub PictureBox1_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles PicMembershipNumber.Click
        ...
        Dim Consum As New SqlConnection(constring)
=======
    Private Sub PictureBox1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PicMembershipNumber.Click
        Dim ds As New DataSet
        Dim SqlDataAdapter1 As New SqlClient.SqlDataAdapter
        Dim Consum As New SqlClient.SqlConnection(constring)
>>>>>>> c3c12be08c1593ad8bd7ed80a18e0ca7a526c28c
