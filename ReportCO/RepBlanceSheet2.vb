...
Public Class RepBlanceSheet2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.RepBlanceSheet2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepBlanceSheet2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepBlanceSheet2 = New RepBlanceSheet2()
        rpt.Site = Me.Site
        Return rpt
    End Function
