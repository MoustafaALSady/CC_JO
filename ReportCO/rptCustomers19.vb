...
Public Class rptCustomers19
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptCustomers19.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomers19
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomers19 = New rptCustomers19()
        rpt.Site = Me.Site
        Return rpt
    End Function
