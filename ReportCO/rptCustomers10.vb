...
Public Class rptCustomers10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptCustomers10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomers10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomers10 = New rptCustomers10()
        rpt.Site = Me.Site
        Return rpt
    End Function
