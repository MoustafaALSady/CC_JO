...
Public Class rptCustomer101
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptCustomer101.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomer101
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomer101 = New rptCustomer101()
        rpt.Site = Me.Site
        Return rpt
    End Function
