...
Public Class rptTransport51
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptTransport51.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTransport51
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransport51 = New rptTransport51()
        rpt.Site = Me.Site
        Return rpt
    End Function
