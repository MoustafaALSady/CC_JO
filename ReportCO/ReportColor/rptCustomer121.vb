...
Public Class rptCustomer121
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptCustomer121.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomer121
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomer121 = New rptCustomer121()
        rpt.Site = Me.Site
        Return rpt
    End Function
