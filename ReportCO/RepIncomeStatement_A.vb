...
Public Class RepIncomeStatement_A
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RepIncomeStatement_A.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.RepIncomeStatement_A.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepIncomeStatement_A
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepIncomeStatement_A = New RepIncomeStatement_A()
        rpt.Site = Me.Site
        Return rpt
    End Function
