...
Public Class RepBlanceSheet_B
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.RepBlanceSheet_B.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepBlanceSheet_B
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepBlanceSheet_B = New RepBlanceSheet_B()
        rpt.Site = Me.Site
        Return rpt
    End Function
