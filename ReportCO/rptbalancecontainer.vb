...
Public Class rptbalancecontainer
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptbalancecontainer.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptbalancecontainer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptbalancecontainer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptbalancecontainer = New rptbalancecontainer()
        rpt.Site = Me.Site
        Return rpt
    End Function
