...
Public Class rptCustomers11
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptCustomers11.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomers11
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomers11 = New rptCustomers11()
        rpt.Site = Me.Site
        Return rpt
    End Function
