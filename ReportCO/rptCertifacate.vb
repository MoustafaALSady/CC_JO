...
Public Class rptCertifacate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptCertifacate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCertifacate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCertifacate = New rptCertifacate()
        rpt.Site = Me.Site
        Return rpt
    End Function
