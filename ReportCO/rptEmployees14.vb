...
Public Class rptEmployees14
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptEmployees14.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmployees14
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmployees14 = New rptEmployees14()
        rpt.Site = Me.Site
        Return rpt
    End Function
