...
Public Class rptReceivableDisclosure
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptReceivableDisclosure.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptReceivableDisclosure.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NNBR() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptReceivableDisclosure
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceivableDisclosure = New rptReceivableDisclosure()
        rpt.Site = Me.Site
        Return rpt
    End Function
