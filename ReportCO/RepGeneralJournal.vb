...
Public Class RepGeneralJournal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.RepGeneralJournal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepGeneralJournal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepGeneralJournal = New RepGeneralJournal()
        rpt.Site = Me.Site
        Return rpt
    End Function
