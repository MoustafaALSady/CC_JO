...
Public Class rptShareholders
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptShareholders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptShareholders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptShareholders = New rptShareholders()
        rpt.Site = Me.Site
        Return rpt
    End Function
