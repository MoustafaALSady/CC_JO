...
Public Class rptEmployees15
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptEmployees15.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmployees15
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmployees15 = New rptEmployees15()
        rpt.Site = Me.Site
        Return rpt
    End Function
