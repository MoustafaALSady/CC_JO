...
Public Class CrystalFixedAssets
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.CrystalFixedAssets.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalFixedAssets
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalFixedAssets = New CrystalFixedAssets()
        rpt.Site = Me.Site
        Return rpt
    End Function
