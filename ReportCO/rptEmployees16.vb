...
Public Class rptEmployees16
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptEmployees16.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmployees16
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmployees16 = New rptEmployees16()
        rpt.Site = Me.Site
        Return rpt
    End Function
