...
Public Class rptAllCustomers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptAllCustomers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAllCustomers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAllCustomers = New rptAllCustomers()
        rpt.Site = Me.Site
        Return rpt
    End Function
