...
Public Class RepBlanceSheetA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.RepBlanceSheetA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ACC() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRepBlanceSheetA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepBlanceSheetA = New RepBlanceSheetA()
        rpt.Site = Me.Site
        Return rpt
    End Function
