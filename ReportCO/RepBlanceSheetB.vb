...
Public Class RepBlanceSheetB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.RepBlanceSheetB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepBlanceSheetB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepBlanceSheetB = New RepBlanceSheetB()
        rpt.Site = Me.Site
        Return rpt
    End Function
