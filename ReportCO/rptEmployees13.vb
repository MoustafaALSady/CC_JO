...
Public Class rptEmployees13
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptEmployees13.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmployees13
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmployees13 = New rptEmployees13()
        rpt.Site = Me.Site
        Return rpt
    End Function
