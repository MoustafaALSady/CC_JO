...
Public Class RepBlanceSheet_A
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.RepBlanceSheet_A.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepBlanceSheet_A
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepBlanceSheet_A = New RepBlanceSheet_A()
        rpt.Site = Me.Site
        Return rpt
    End Function
