...
Public Class rptSearchCustoms
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptSearchCustoms.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSearchCustoms
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSearchCustoms = New rptSearchCustoms()
        rpt.Site = Me.Site
        Return rpt
    End Function
