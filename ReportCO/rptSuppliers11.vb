...
Public Class rptSuppliers11
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptSuppliers11.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSuppliers11
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSuppliers11 = New rptSuppliers11()
        rpt.Site = Me.Site
        Return rpt
    End Function
