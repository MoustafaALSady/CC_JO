...
Public Class RepBlanceSheet1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.RepBlanceSheet1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepBlanceSheet1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepBlanceSheet1 = New RepBlanceSheet1()
        rpt.Site = Me.Site
        Return rpt
    End Function
