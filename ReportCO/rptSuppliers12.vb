...
Public Class rptSuppliers12
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CC_JO.rptSuppliers12.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSuppliers12
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSuppliers12 = New rptSuppliers12()
        rpt.Site = Me.Site
        Return rpt
    End Function
